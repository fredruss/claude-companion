...
function useStateTransition(targetState) {
  const [currentState, setCurrentState] = reactExports.useState(targetState);
...
const petFaces = {
  idle: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 100 100", className: "pet-svg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "45", fill: "#FFB347" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "35", cy: "40", r: "5", fill: "#333" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "65", cy: "40", r: "5", fill: "#333" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M 35 60 Q 50 70 65 60", stroke: "#333", strokeWidth: "3", fill: "none" })
  ] }),
  working: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 100 100", className: "pet-svg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "45", fill: "#87CEEB" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "35", cy: "40", r: "5", fill: "#333" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "65", cy: "40", r: "5", fill: "#333" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M 35 62 Q 50 75 65 62", stroke: "#333", strokeWidth: "3", fill: "none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "50", y: "85", textAnchor: "middle", fontSize: "12", fill: "#333", children: "..." })
  ] }),
  reading: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 100 100", className: "pet-svg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "45", fill: "#DDA0DD" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "35", cy: "40", rx: "8", ry: "5", fill: "#333" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "65", cy: "40", rx: "8", ry: "5", fill: "#333" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "37", cy: "39", r: "2", fill: "#fff" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "67", cy: "39", r: "2", fill: "#fff" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M 40 60 L 60 60", stroke: "#333", strokeWidth: "2" })
  ] }),
  done: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 100 100", className: "pet-svg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "45", fill: "#90EE90" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M 30 40 Q 35 35 40 40", stroke: "#333", strokeWidth: "2", fill: "none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M 60 40 Q 65 35 70 40", stroke: "#333", strokeWidth: "2", fill: "none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M 30 60 Q 50 80 70 60", stroke: "#333", strokeWidth: "3", fill: "none" })
  ] }),
  error: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 100 100", className: "pet-svg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "45", fill: "#FFB6C1" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "30", y1: "35", x2: "40", y2: "45", stroke: "#333", strokeWidth: "3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "40", y1: "35", x2: "30", y2: "45", stroke: "#333", strokeWidth: "3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "60", y1: "35", x2: "70", y2: "45", stroke: "#333", strokeWidth: "3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "70", y1: "35", x2: "60", y2: "45", stroke: "#333", strokeWidth: "3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M 35 70 Q 50 60 65 70", stroke: "#333", strokeWidth: "3", fill: "none" })
  ] })
};
function Pet({ state }) {
  const { currentState, isTransitioning } = useStateTransition(state);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `pet-container ${isTransitioning ? "transitioning" : ""} pet-${currentState}`, children: petFaces[currentState] });
}
function useAutoHide(shouldHide, delay, dependencies) {
...
const HIDE_DELAY = 1e4;
function StatusBubble({ action, status }) {
  const visible = useAutoHide(status === "idle", HIDE_DELAY, [action, status]);
  if (!visible) {
    return null;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `status-bubble status-${status}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bubble-content", children: action }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bubble-tail" })
  ] });
}
const defaultStatus = {
  status: "idle",
...
function useStatus() {
  const [status, setStatus] = reactExports.useState(defaultStatus);
  reactExports.useEffect(() => {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBubble, { action: status.action, status: status.status }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Pet, { state: status.status })
  ] });
}
